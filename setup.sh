...
rm -rf sqlparser*
#soar
curl -L -q https://github.com/XiaoMi/soar/releases/download/0.11.0/soar.linux-amd64 -o soar
chmod +x soar
#my2sql
...
sh -c "echo /data/oracle/instantclient_19_21 > /etc/ld.so.conf.d/oracle-instantclient.conf"
ldconfig
